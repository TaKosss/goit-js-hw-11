...
(0, _refs.refs).loadmoreBtn.style.display = "none";
let page = 1;
let gallerySimpleLightbox = new (0, _simplelightboxDefault.default)(".gallery a");
(0, _refs.refs).submitBtn.addEventListener("click", onSearchClick);
(0, _refs.refs).loadmoreBtn.addEventListener("click", onLoadMoreClick);
async function onSearchClick(e) {
    e.preventDefault();
    cleanGallery();
    const inputValue = (0, _refs.refs).searchFormInput.value.trim();
    if (inputValue === "") return;
    const data = await (0, _fetchImage.fetchImage)(inputValue, page);
    ...
    (0, _refs.refs).loadmoreBtn.style.display = "block";
...
function onLoadMoreClick(e) {
    ...
    const inputValue = (0, _refs.refs).searchFormInput.value.trim();
    (0, _refs.refs).loadmoreBtn.style.display = "none";
    (0, _fetchImage.fetchImage)(inputValue, page).then((foundData)=>{
...
function renderPhotoCard(photo) {
    const markup = photo.map(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads ,  })=>{
    ...
    (0, _refs.refs).galleryContainer.innerHTML += markup;
}
function cleanGallery() {
    page = 1;
    (0, _refs.refs).galleryContainer.innerHTML = "";
    (0, _refs.refs).loadmoreBtn.style.display = "none";
}

},{"simplelightbox":"9ydBq","notiflix":"5WWYd","./refs":"2WoF2","./fetchImage":"gIB0J","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ydBq":[function(require,module,exports) {
/*!
...
async function fetchImage(searchQuery, page) {
    ...
    try {
        const response = await (0, _axiosDefault.default).get(fetchImageUrl.toString());
...
},{"./../utils":"5By4s"}],"kaxSc":[function() {},{}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequirea610")
